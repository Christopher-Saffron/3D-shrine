...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/ALL1.glb')
  return (
    <group {...props} dispose={null}>
      <group position={[-3.82, 0.99, 1.2]} rotation={[0, 1.41, 0]} scale={0.39}>
        ...
        <group position={[11.71, 0.51, -10.79]}>
          ...
          <mesh geometry={nodes.Object_0069_7.geometry} material={materials.testTexture} />
      ...
      <mesh geometry={nodes.BudkaBlog.geometry} material={materials.testTexture} position={[-6.62, -0.15, 1.99]} scale={1.08} />
