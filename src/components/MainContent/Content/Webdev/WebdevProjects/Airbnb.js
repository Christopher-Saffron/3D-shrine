  ...
  return (
    ...
    <div className='projectShow__flexBox'>
      <div className='projectShow__infoPanel'>
        ...
        <p><span className='projectShow__secondColor'>Live Link:</span> <a className='projectShow__link' target="_blank" rel="noopener noreferrer" href='https://nipponair.vercel.app/'>https://havirbnb.vercel.app/</a></p>
    ...
    <p className='projectShow__paragraph'>
      <span className='projectShow__secondColor'>Using Airbnb</span> as a mean to practice with payments as well as maps, databases and some simple 3d objects.
    </p>
  </>
  )
}
