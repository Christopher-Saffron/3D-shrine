...
const ContactBox = ({toggleContactBox}) => {
  return (
    <div className='welcome__div' onClick={(e) => {toggleContactBox(false)}}>
        <div className='welcome__tab welcome__tab_flex' onClick={(e) => {e.stopPropagation()}}>
            <a target="_blank" rel="noopener noreferrer" href='https://www.google.com/maps/place/Krak%C3%B3w/' className='welcome__tab_flexItem'>
            ...
            <div className='welcome__exit' onClick={() => {toggleContactBox(false)}}>
                <span>+</span>
            </div>
        </div>
    </div>
