...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/Object3.glb')

  
  useEffect(() => {
    if(!materials) return;

    materials.texturki.toneMapped = true;
    materials.texturki.roughness = .8;
    materials.texturki.metalness = .5;
    materials.texturki.transparent = true;
    materials.texturki.side = DoubleSide;
    ...
    <group {...props} dispose={null}>
      <group position={[-3.82, 0.99, 1.2]} rotation={[0, 1.41, 0]} scale={0.39}>
        ...
        <group position={[11.71, 0.51, -10.79]}>
          ...
          <mesh geometry={nodes.Object_0069_7.geometry} material={materials.texturki} />
      ...
      <group position={[-3.82, 1.11, 2.2]} rotation={[2.94, 0, 0]}>
        <mesh geometry={nodes.Object_0042.geometry} material={materials.texturki} />
      ...
      <mesh geometry={nodes.BudkaBlog.geometry} material={materials.texturki} />
      <mesh geometry={nodes.BudkaBricscad.geometry} material={materials.texturki} />
      <mesh geometry={nodes.budka3D.geometry} material={materials.texturki} />
      <mesh geometry={nodes.BudkaVideos.geometry} material={materials.texturki} />
      <mesh geometry={nodes.BudkaUnity.geometry} material={materials.texturki} />
      <mesh geometry={nodes.BudkaWebdev.geometry} material={materials.texturki} />
      <mesh geometry={nodes.BudkaLanguages.geometry} material={materials.texturki} />
    </group>
  )
}

useGLTF.preload('/Object3.glb')
