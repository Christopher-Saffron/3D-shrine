...
export default function Model(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.BudkaProjects.geometry} onClick={() => {props.setnewCameraArgs([-6.5, 1.6, 5.5, 0, 0, 0, 50])}} onPointerEnter={() => {toggleHovered(true)}} onPointerLeave={() => {toggleHovered(false)}} receiveShadow  castShadow material={materials.testTexture} position={[-6.62, -0.15, 1.99]} scale={1.08} />
      <mesh geometry={nodes.BudkaBricscad.geometry} onClick={() => {props.setnewCameraArgs([-9.7, 1.95, 9.5, -1, Math.PI /5, .9, 60])}} onPointerEnter={() => {toggleHovered(true)}} onPointerLeave={() => {toggleHovered(false)}} receiveShadow  castShadow  material={materials.testTexture} position={[-10.95, 0.15, 8.87]} rotation={[0, -1.55, 0]} scale={1.12} />
      <mesh geometry={nodes.Budka3D.geometry} onClick={() => {props.setnewCameraArgs([-6.3, 1.4, 7.4, .2, 3.7, .1, 50])}} onPointerEnter={() => {toggleHovered(true)}} onPointerLeave={() => {toggleHovered(false)}} receiveShadow  castShadow  material={materials.testTexture} position={[-5.59, 0.21, 8.4]} rotation={[0, 0.65, 0]} />
      <mesh geometry={nodes.BudkaVideos.geometry} onClick={() => {props.setnewCameraArgs([-2.6, 1.78, 3.15, -.3, 0, 0, 90])}} onPointerEnter={() => {toggleHovered(true)}} onPointerLeave={() => {toggleHovered(false)}} receiveShadow   castShadow material={materials.testTexture} position={[-2.74, 0.4, 1.8]} />
      <mesh geometry={nodes.BudkaUnity.geometry} onClick={() => {props.setnewCameraArgs([-10.4, 1.25, 4.8, 0, 0, 0, 50])}} onPointerEnter={() => {toggleHovered(true)}} onPointerLeave={() => {toggleHovered(false)}} receiveShadow  castShadow  material={materials.testTexture} position={[-10.53, 0.89, 1.96]} scale={1.33} />
      <mesh geometry={nodes.BudkaWebdev.geometry} onClick={() => {props.setnewCameraArgs([-2.3, 1.48, 5.95, .3, Math.PI, 0, 80])}} onPointerEnter={() => {toggleHovered(true)}} onPointerLeave={() => {toggleHovered(false)}} receiveShadow castShadow  material={materials.testTexture} position={[-2.23, 0.28, 7.74]} scale={1.02} />
      <mesh geometry={nodes.BudkaLanguages.geometry} onClick={() => {props.setnewCameraArgs([-9.7, 1.95, 14.9, -1, Math.PI /5, .9, 60])}} onPointerEnter={() => {toggleHovered(true)}} onPointerLeave={() => {toggleHovered(false)}} receiveShadow  castShadow  material={materials.testTexture} position={[-11.21, -0.53, 13.68]} rotation={[-Math.PI, 1.55, -Math.PI]} />
