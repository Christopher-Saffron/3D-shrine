...
export const WEBDEVDATA = [
  ...
  
  {
    ...
    description: 'Online Marketplace with 3D models, STRIPE and Paypal, maps, login and reservation.',
  ...
  // },
  {
    ...
    tags: ['frontEnd', 'backEnd', 'nextjs',  'sanity', 'tailwind', 'typescript', 'responsive']
  },
  {
